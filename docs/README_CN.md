...
- ⚡ **闪电般快速筛选** - 键盘快捷键实现快速选择（P/X/U）或星级评分（1-5）
...
- **双模式分类**：在精选/删除和星级评分工作流之间切换
- **流畅导航**：方向键和缩略图条浏览

### ⭐ 分类模式

- **精选/删除模式**：经典筛选工作流，使用快捷键（P/X/U）
- **星级评分模式**：使用数字键 1-5 评分，按 0 清除评分
- **模式切换**：在设置面板中轻松切换
- **智能筛选**：按评分阈值筛选（5★、4+★、3+★、未评分）
